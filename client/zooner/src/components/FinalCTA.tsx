...
export const FinalCTA: React.FC<FinalCTAProps> = ({ onSearchClick, onOpenRetailerModal }) => {
  return (
    <section className="relative py-32 sm:py-48 px-6 sm:px-8 bg-[#06070F] text-white border-t border-slate-800/60 overflow-hidden text-center">
      ...
      >
        <span className="text-xs font-mono uppercase tracking-widest text-indigo-400 font-bold block">
          Available Now � Free on iOS & Android
        </span>
        ...
        <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-4 rounded-full border border-slate-800 hover:border-slate-700 text-sm font-semibold text-slate-300 transition-colors cursor-pointer"
          >
